 ...
 * @apiNote The properties alternative, min choices and max choices are part of OVM.
 */
public interface IOvModelVariationPoint extends IOvModelVariationBase {
    ...
    /**
     * This method sets the property alternative of this {@link IOvModelVariationPoint}.
     *
    ...
    /**
     * This method sets the property min choices of this {@link IOvModelVariationPoint}. It determines the minimum children which have to be chosen.
     *
    ...
    /**
     * This method returns <code>true</code>, if there is a maximal amount of choices defined for this variation point. It is defined if <code>maxChoices != -1
     * </code>.
     *
    ...
    /**
     * This method sets the property max choices of this {@link IOvModelVariationPoint}. It determines the maximum amount of children which can be chosen.
     *
    ...
    /**
     * This method removes a mandatory child from this variation point. Which child should be removed is determined by the equals method.
     *
    ...
    /**
     * This method removes an optional child from this variation point. Which child should be removed is determined by the equals method.
     *
