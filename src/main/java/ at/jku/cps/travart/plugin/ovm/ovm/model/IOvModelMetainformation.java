 ...
 * however cannot be represented by an {@link IOvModel}. In this case it is solely the description and the properties are stored.
 */
public interface IOvModelMetainformation {
     ...
     * from the {@link IFeatureModel} during transformation. They have been added so that no information will be lost during transformation.
     *
