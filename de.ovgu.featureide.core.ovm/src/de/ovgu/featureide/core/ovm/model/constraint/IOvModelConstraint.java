...
public abstract interface IOvModelConstraint extends IOvModelElement, IValidate {
	...
	/**
	 * This method returns the well defined source of this constraint as variation base (variation point or variant).
	 *
	...
	/**
	 * This method sets the source of this {@link IOvModel} constraint. An OvModel constrain has always a well defined source.
	 *
	...
	/**
	 * This method returns the well defined target of this constraint as variation base (variation point or variant).
	 *
	...
	/**
	 * This method sets the target of this {@link IOvModel} constraint. An OvModel constrain has always a well defined target.
	 *
