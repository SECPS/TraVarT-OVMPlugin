...
import de.ovgu.featureide.core.ovm.format.impl.exc.OvModelWrongCountOfElements;
import de.ovgu.featureide.core.ovm.format.impl.exc.OvModelWrongElementException;
...
public class ReadHelper {
	 ...
	 * @throws OvModelSerialisationException
	 */
	private static IOvModelElement read(Element element, IOvModel ovModel, IOvModelFactory factory) throws OvModelSerialisationException {
	...
	public static void read(Element element, IOvModelVariant object, IOvModel ovModel, IOvModelFactory factory) throws OvModelSerialisationException {
		readProperties(element, (IOvModelVariationBase) object, ovModel, factory);
	}
	...
	public static void read(Element element, IOvModelVariationPoint object, IOvModel ovModel, IOvModelFactory factory) throws OvModelSerialisationException {
		...
		if (ovMandatoryChildren != null) {
			for (final Element childElement : getChildElements(ovMandatoryChildren, true)) {
				final IOvModelVariationBase ovModelVariationBase = (IOvModelVariationBase) read(childElement, ovModel, factory);
	...
	public static void read(Element element, IOvModelVariationBaseMetainformation object, IOvModel ovModel, IOvModelFactory factory)
		...
		if (referencedConstraints != null) {
			for (final Element childElement : getChildElements((Element) referencedConstraints, true)) {
	...
	public static void readProperties(Element element, IOvModelVariationBase object, IOvModel ovModel, IOvModelFactory factory)
		...
		final Element metainformation = getChildElementByTagName(element, OV_MODEL_VARIATION_BASE_METAINFORMATION, true);
	 ...
	 * @throws OvModelSerialisationException
	 */
	private static Element getChildElementByTagName(Element element, String name, boolean throwExceptionWhenNotFound) throws OvModelSerialisationException {
